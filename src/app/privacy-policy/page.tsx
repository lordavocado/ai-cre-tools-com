...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Sheet2Site Pro.',
};
  ...
  return (
    <div className="container py-12 md:py-16 max-w-3xl mx-auto">
      ...
      <div className="prose prose-lg dark:prose-invert">
        ...
        <p>Welcome to Sheet2Site Pro ("us", "we", or "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us.</p>
        ...
        <p>The personal information that we collect depends on the context of your interactions with us and the Website, the choices you make and the products and features you use. The personal information we collect may include the following: email address for newsletter subscriptions.</p>
        ...
        <p>If you have questions or comments about this notice, you may email us at [your-contact-email@example.com].</p>
      </div>
    </div>
  );
}
