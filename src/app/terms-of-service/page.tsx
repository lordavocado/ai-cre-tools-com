        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <div className="bg-green-50 dark:bg-green-950/30 p-6 rounded-lg border border-green-200 dark:border-green-800 mb-8">
            ...
            <p className="text-green-800 dark:text-green-200 text-sm">
              By using {siteConfig.name}, you agree to use our service responsibly, respect intellectual property rights, 
              and understand that we provide information for reference purposes. We're committed to maintaining a helpful, 
              accurate directory of {siteConfig.categoryName.toLowerCase()}.
            </p>
          </div>
          ...
          <p>{siteConfig.name} provides a comprehensive directory and comparison platform for {siteConfig.categoryName.toLowerCase()}. Our service includes:</p>
          
          <ul>
            <li><strong>Directory Listings:</strong> Curated information about AI tools and software</li>
            <li><strong>Comparison Features:</strong> Side-by-side tool comparisons</li>
            ...
            <li><strong>Search and Filtering:</strong> Advanced discovery features</li>
          </ul>
          ...
          <div className="grid md:grid-cols-2 gap-4 my-4">
            <div>
              ...
              <ul className="text-sm space-y-1">
                ...
                <li>• Compilation and organization</li>
            ...
            <div>
              ...
              <ul className="text-sm space-y-1">
                <li>• Tool logos and names belong to respective owners</li>
                <li>• Screenshots used under fair use</li>
          ...
          <p>Our service provides information, not professional advice. You should:</p>
          <ul>
            <li>Conduct your own due diligence before purchasing tools</li>
            <li>Consult with professionals for business decisions</li>
            <li>Verify information independently</li>
            <li>Consider your specific needs and circumstances</li>
          </ul>
          ...
          <ul>
            ...
            <li>Our compliance with privacy regulations</li>
          </ul>
          ...
          <ul>
            ...
            <li>Notify newsletter subscribers of material changes</li>
          ...
          without regard to its conflict of law provisions. Any disputes shall be resolved in the courts of [Your Jurisdiction].</p>
